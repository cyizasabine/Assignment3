...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _connectivityService.onConnectivityChanged
      ...
      print('Connectivity changed: $result'); // Add debug print here
  ...
  Future<void> _initConnectivity() async {
    ...
    try {
      ...
      print('Initial connectivity: $result'); // Debug print
    } catch (e) {
      print('Connectivity check failed: $e'); // Debug print
  ...
  void _showConnectivityToast(ConnectivityResult result) {
    ...
    print('Connectivity change: $message'); // Debug print
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: ListView(
          ...
          controller: _scrollController, // Provide a scroll controller here
          children: <Widget>[
            DrawerHeader(
